...
export interface FundingReadOnlyInterface {
  ...
  queryTotalDonated: () => Promise<QueryTotalDonatedResponse>
  queryGetCampaign: ({
    campaignName,
  }: {
    campaignName: string
...
export class FundingQueryClient implements FundingReadOnlyInterface {
  ...
  queryTotalDonated = async (): Promise<QueryTotalDonatedResponse> => {
...
export class FundingClient extends FundingQueryClient
